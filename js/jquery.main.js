...
function initSlickCarousel() {
	jQuery('.product-carousel').slick({
		...
		rows: 0,
		slidesToShow: 3,
		prevArrow: '<a href="#" class="slick-prev"><span class="icon-left"></span></a>',
		nextArrow: '<a  href="#" class="slick-next"><span class="icon-right"></span></a>',
		responsive: [{
			breakpoint: 1024,
			settings: {
				slidesToShow: 2
...
function initLightbox() {
	jQuery('a.lightbox, .btn-ligtbox').fancybox({
		helpers: {
			overlay: {
				css: {
...
function initAnchors() {
	new SmoothScroll({
		anchorLinks: 'a[href^="#about-us"]:not([href="#"])',
		extraOffset: 0,
		wheelBehavior: 'none'
	});
	new SmoothScroll({
		anchorLinks: 'a[href^="#our-products"]:not([href="#"])',
		extraOffset: 0,
		wheelBehavior: 'none'
	});
	new SmoothScroll({
		anchorLinks: 'a[href^="#characteristics"]:not([href="#"])',
		extraOffset: 0,
		wheelBehavior: 'none'
	});
	new SmoothScroll({
		anchorLinks: 'a[href^="#advertising"]:not([href="#"])',
		extraOffset: 0,
		wheelBehavior: 'none'
	});
	new SmoothScroll({
		anchorLinks: 'a[href^="#attachment-section"]:not([href="#"])',
		extraOffset: 0,
		wheelBehavior: 'none'
	});
	new SmoothScroll({
		anchorLinks: 'a[href^="#info-section"]:not([href="#"])',
		extraOffset: 0,
		wheelBehavior: 'none'
	});
	new SmoothScroll({
		anchorLinks: 'a[href^="#contact-us"]:not([href="#"])',
		extraOffset: 0,
		wheelBehavior: 'none'
	});
}
